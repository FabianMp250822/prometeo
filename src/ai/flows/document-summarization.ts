...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert at summarizing documents. Please provide a concise summary of the document provided.  The summary should focus on the key information and purpose of the document.
